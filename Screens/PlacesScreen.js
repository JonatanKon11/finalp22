...
const PlacesScreen = () => {
  ...
  return (
    <SafeAreaView>
      <Pressable 
      style={{flexDirection:"row", alignItems:"center",justifyContent:"space-between",paddingHorizontal:20,padding:12,backgroundColor:"white"}}>
        ...
        {data
            ...
            .map((item) => 
                ...
                <PropertyCard 
                    ...
                    selectadDates={route.params.selectadDates}
                    property={property}
