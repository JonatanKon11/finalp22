  ...
  return (
    <View>
      <Pressable style={{margin:15,flexDirection:"row",backgroundColor:"white"}}>
        <View>
            <Image style={{height:height/4, width:width - 250}} source={{uri:property.image}}/>
        </View>
        ...
        <View style={{padding:10}}>
            ...
            <View style={{flexDirection:"row",alignItems:"center",gap:6, marginTop:7}}>
                ...
                <Text style={{textAlign:"center",color:"white", fontSize:15}}>Genius Level</Text>
                    ...
                    <Text style={{ width: 210, marginTop: 6, color: "gray", fontWeight: "bold" }}>{property.address.length > 50 ? property.address.substr(0, 50) : property.address}</Text>
                    ...
                    <View style={{marginTop:5, flexDirection:"row",alignItems:"center",gap:8}}>
                        ...
                        <Text style={{color:"green",fontSize:18}}> Rs {property.newPrice * adults }</Text>
                    </View>
                    <View style={{marginTop:6}}>
                        <Text style={{fontSize:16,color:"gray"}}>Deluxe Room </Text>
                        <Text style={{fontSize:16,color:"gray"}}>Hotel Room : 1 bed </Text>
                    </View>
                    <View style={{ backgroundColor: "#6082B6", paddingVertical: 3,marginTop:2, borderRadius: 5,width: 150, paddingHorizontal:3 }}>
