    ...
    <ScrollView horizontal showsHorizontalScrollIndicator={false}>
      ...
      <Image
        ...
        <View style={{backgroundColor:"orange", width:190, padding:10}}>
            <Text style={{fontSize:16, fontWeight:"bold", color:"white"}}>Madikeri</Text>
            <Text style={{color:"white",fontSize:14,fontWeight:"400"}}>280km away</Text>
        </View>
      </Pressable>
      ...
      <Image
        ...
        />
         <View style={{backgroundColor:"orange", width:190, padding:10}}>
            <Text style={{fontSize:16, fontWeight:"bold", color:"white"}}>Chickmagalur</Text>
            <Text style={{color:"white",fontSize:14,fontWeight:"400"}}>250km away</Text>
        </View>
      </Pressable>
      ...
      <Image
        ...
        />
         <View style={{backgroundColor:"orange", width:190, padding:10}}>
            <Text style={{fontSize:16, fontWeight:"bold", color:"white"}}>Chennai</Text>
            <Text style={{color:"white",fontSize:14,fontWeight:"400"}}>380km away</Text>
        </View>
      </Pressable>
      ...
      <Image
        ...
        />
         <View style={{backgroundColor:"orange", width:190, padding:10}}>
            <Text style={{fontSize:16, fontWeight:"bold", color:"white"}}>Coorg</Text>
            <Text style={{color:"white",fontSize:14,fontWeight:"400"}}>300km away</Text>
        </View>
      </Pressable>
      </ScrollView>
